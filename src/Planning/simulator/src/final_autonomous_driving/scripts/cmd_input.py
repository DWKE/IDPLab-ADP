...
if __name__ == '__main__':
    ...
    pub = rospy.Publisher('control_cmd', Control, queue_size=10)
    ...
    try:
        ...
        while(1):
            ...
            input = Control()
            input.gear = 0
            input.speed = accel/100.0*20.0
            input.steer = frontAngle/45.0*28.0#/180.0*PI
            input.brake = (brake/100.0*199.0) + 1
            pub.publish(input)
            rate.sleep()
